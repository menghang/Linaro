...
enum opt_code
{
  ...
  OPT_s = 1149,                              /* -s */
  OPT_s_bc_abi = 1150,                       /* -s-bc-abi */
  OPT_save_temps = 1151,                     /* -save-temps */
  OPT_save_temps_ = 1152,                    /* -save-temps= */
  OPT_shared = 1153,                         /* -shared */
  OPT_shared_libgcc = 1154,                  /* -shared-libgcc */
  /* OPT_specs = 1155, */                    /* -specs */
  OPT_specs_ = 1156,                         /* -specs= */
  OPT_static = 1157,                         /* -static */
  OPT_static_libasan = 1158,                 /* -static-libasan */
  OPT_static_libgcc = 1159,                  /* -static-libgcc */
  OPT_static_libgcj = 1160,                  /* -static-libgcj */
  OPT_static_libgfortran = 1161,             /* -static-libgfortran */
  OPT_static_libgo = 1162,                   /* -static-libgo */
  OPT_static_liblsan = 1163,                 /* -static-liblsan */
  ...
  /* OPT_std_gnu__14 = 1187, */              /* -std=gnu++14 */
