...
enum opt_code
{
  ...
  OPT_flto_partition_ = 720,                 /* -flto-partition= */
  OPT_flto_report = 721,                     /* -flto-report */
  OPT_flto_report_wpa = 722,                 /* -flto-report-wpa */
  OPT_flto_ = 723,                           /* -flto= */
  OPT_fltrans = 724,                         /* -fltrans */
  OPT_fltrans_output_list_ = 725,            /* -fltrans-output-list= */
  OPT_fmain_ = 726,                          /* -fmain= */
  OPT_fmath_errno = 727,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 728,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 729,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 730,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 731,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 732,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 733,                     /* -fmem-report */
  OPT_fmem_report_wpa = 734,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 735,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 736,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 737,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 738,                /* -fmessage-length= */
  OPT_fmodule_private = 739,                 /* -fmodule-private */
  OPT_fmodulo_sched = 740,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 741,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 742,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 743,                  /* -fms-extensions */
  /* OPT_fmudflap = 744, */                  /* -fmudflap */
  /* OPT_fmudflapir = 745, */                /* -fmudflapir */
  /* OPT_fmudflapth = 746, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 747, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 748, */                  /* -fnew-abi */
  OPT_fnext_runtime = 749,                   /* -fnext-runtime */
  OPT_fnil_receivers = 750,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 751, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 752,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 753,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 754, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 755,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 756,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 757,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 758,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 759,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 760,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 761,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 762,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 763,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 764,             /* -fomit-frame-pointer */
  OPT_fopenmp = 765,                         /* -fopenmp */
  OPT_fopenmp_simd = 766,                    /* -fopenmp-simd */
  OPT_foperator_names = 767,                 /* -foperator-names */
  OPT_fopt_info = 768,                       /* -fopt-info */
  OPT_fopt_info_ = 769,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 770, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 771,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 772,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 773,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 774, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 775,              /* -foutput-class-dir= */
  OPT_fpack_derived = 776,                   /* -fpack-derived */
  OPT_fpack_struct = 777,                    /* -fpack-struct */
  OPT_fpack_struct_ = 778,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 779,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 780,              /* -fpcc-struct-return */
  OPT_fpch_deps = 781,                       /* -fpch-deps */
  OPT_fpch_preprocess = 782,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 783,                     /* -fpeel-loops */
  OPT_fpeephole = 784,                       /* -fpeephole */
  OPT_fpeephole2 = 785,                      /* -fpeephole2 */
  OPT_fpermissive = 786,                     /* -fpermissive */
  OPT_fpic = 787,                            /* -fpic */
  OPT_fpie = 788,                            /* -fpie */
  OPT_fplan9_extensions = 789,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 790,                    /* -fplugin-arg- */
  OPT_fplugin_ = 791,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 792,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 793,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 794,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 795,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 796,                   /* -fpreprocessed */
  OPT_fpretty_templates = 797,               /* -fpretty-templates */
  OPT_fprofile = 798,                        /* -fprofile */
  OPT_fprofile_arcs = 799,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 800,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 801,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 802,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 803,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 804,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 805,                 /* -fprofile-report */
  OPT_fprofile_use = 806,                    /* -fprofile-use */
  OPT_fprofile_use_ = 807,                   /* -fprofile-use= */
  OPT_fprofile_values = 808,                 /* -fprofile-values */
  OPT_fprotect_parens = 809,                 /* -fprotect-parens */
  OPT_frandom_seed = 810,                    /* -frandom-seed */
  OPT_frandom_seed_ = 811,                   /* -frandom-seed= */
  OPT_frange_check = 812,                    /* -frange-check */
  OPT_freal_4_real_10 = 813,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 814,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 815,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 816,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 817,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 818,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 819,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 820,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 821,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 822,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 823,                /* -frecord-marker=8 */
  OPT_frecursive = 824,                      /* -frecursive */
  OPT_freduced_reflection = 825,             /* -freduced-reflection */
  OPT_free = 826,                            /* -free */
  OPT_freg_struct_return = 827,              /* -freg-struct-return */
  /* OPT_fregmove = 828, */                  /* -fregmove */
  OPT_frename_registers = 829,               /* -frename-registers */
  OPT_freorder_blocks = 830,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 831,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 832,              /* -freorder-functions */
  OPT_frepack_arrays = 833,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 834,           /* -freplace-objc-classes */
  OPT_frepo = 835,                           /* -frepo */
  OPT_frequire_return_statement = 836,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 837,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 838, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 839,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 840,                    /* -fresolution= */
  OPT_frounding_math = 841,                  /* -frounding-math */
  OPT_frtti = 842,                           /* -frtti */
  OPT_fsanitize_ = 843,                      /* -fsanitize= */
  OPT_fsaw_java_file = 844,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 845,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 846,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 847,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 848,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 849,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 850,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 851,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 852,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 853,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 854,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 855,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 856,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 857,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 858,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 859,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 860,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 861,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 862, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 863,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 864,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 865,              /* -fsecond-underscore */
  OPT_fsection_anchors = 866,                /* -fsection-anchors */
  /* OPT_fsee = 867, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 868,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 869,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 870, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 871,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 872,          /* -fselective-scheduling2 */
  OPT_fshort_double = 873,                   /* -fshort-double */
  OPT_fshort_enums = 874,                    /* -fshort-enums */
  OPT_fshort_wchar = 875,                    /* -fshort-wchar */
  OPT_fshow_column = 876,                    /* -fshow-column */
  OPT_fshrink_wrap = 877,                    /* -fshrink-wrap */
  OPT_fsign_zero = 878,                      /* -fsign-zero */
  OPT_fsignaling_nans = 879,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 880,               /* -fsigned-bitfields */
  OPT_fsigned_char = 881,                    /* -fsigned-char */
  OPT_fsigned_zeros = 882,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 883,               /* -fsimd-cost-model= */
  ...
  OPT_fstack_protector_strong = 899,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 900,                   /* -fstack-reuse= */
  OPT_fstack_usage = 901,                    /* -fstack-usage */
  OPT_fstats = 902,                          /* -fstats */
  OPT_fstore_check = 903,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 904, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 905,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 906,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 907,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 908, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 909,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 910,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 911,                    /* -fsyntax-only */
  OPT_ftabstop_ = 912,                       /* -ftabstop= */
  /* OPT_ftarget_help = 913, */              /* -ftarget-help */
  OPT_ftarget_ = 914,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 915,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 916, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 917,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 918,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 919, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 920,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 921,             /* -fthreadsafe-statics */
  OPT_ftime_report = 922,                    /* -ftime-report */
  OPT_ftls_model_ = 923,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 924,               /* -ftoplevel-reorder */
  OPT_ftracer = 925,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 926,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 927,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 928,                  /* -ftrapping-math */
  OPT_ftrapv = 929,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 930,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 931,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 932,                       /* -ftree-ccp */
  OPT_ftree_ch = 933,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 934,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 935,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 936,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 937,                /* -ftree-copyrename */
  OPT_ftree_cselim = 938,                    /* -ftree-cselim */
  OPT_ftree_dce = 939,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 940,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 941,                       /* -ftree-dse */
  OPT_ftree_forwprop = 942,                  /* -ftree-forwprop */
  OPT_ftree_fre = 943,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 944,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 945,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 946,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 947,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 948,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 949,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 950, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 951,             /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 952,            /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 953,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 954,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 955,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 956,                   /* -ftree-phiprop */
  OPT_ftree_pre = 957,                       /* -ftree-pre */
  OPT_ftree_pta = 958,                       /* -ftree-pta */
  OPT_ftree_reassoc = 959,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 960, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 961,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 962,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 963,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 964,                      /* -ftree-slsr */
  OPT_ftree_sra = 965,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 966, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 967, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 968,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 969,                /* -ftree-tail-merge */
  OPT_ftree_ter = 970,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 971, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 972,                 /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 973, */ /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 974,                       /* -ftree-vrp */
  OPT_funderscoring = 975,                   /* -funderscoring */
  OPT_funit_at_a_time = 976,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 977,               /* -funroll-all-loops */
  OPT_funroll_loops = 978,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 979,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 980,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 981,             /* -funsigned-bitfields */
  OPT_funsigned_char = 982,                  /* -funsigned-char */
  OPT_funswitch_loops = 983,                 /* -funswitch-loops */
  OPT_funwind_tables = 984,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 985,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 986,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 987,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 988,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 989,          /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 990,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 991,                    /* -fuse-ld=gold */
  OPT_fuse_ld_mcld = 992,                    /* -fuse-ld=mcld */
  OPT_fuse_linker_plugin = 993,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 994,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 995,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 996,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 997,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 998, /* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 999, */          /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1000,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1001,                   /* -fverbose-asm */
  /* OPT_fversion = 1002, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1003,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1004,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1005,                   /* -fvisibility= */
  OPT_fvpt = 1006,                           /* -fvpt */
  /* OPT_fvtable_gc = 1007, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1008, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1009,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1010,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1011,                     /* -fvtv-debug */
  OPT_fweak = 1012,                          /* -fweak */
  OPT_fweb = 1013,                           /* -fweb */
  /* OPT_fwhole_file = 1014, */              /* -fwhole-file */
  OPT_fwhole_program = 1015,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1016,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1017,             /* -fworking-directory */
  OPT_fwpa = 1018,                           /* -fwpa */
  OPT_fwpa_ = 1019,                          /* -fwpa= */
  OPT_fwrapv = 1020,                         /* -fwrapv */
  /* OPT_fxref = 1021, */                    /* -fxref */
  /* OPT_fzee = 1022, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1023,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1024,                     /* -fzero-link */
  OPT_g = 1025,                              /* -g */
  OPT_gant = 1026,                           /* -gant */
  OPT_gcoff = 1027,                          /* -gcoff */
  OPT_gdwarf = 1028,                         /* -gdwarf */
  OPT_gdwarf_ = 1029,                        /* -gdwarf- */
  OPT_gen_decls = 1030,                      /* -gen-decls */
  OPT_ggdb = 1031,                           /* -ggdb */
  OPT_ggnu_pubnames = 1032,                  /* -ggnu-pubnames */
  OPT_gnat = 1033,                           /* -gnat */
  OPT_gnatO = 1034,                          /* -gnatO */
  OPT_gno_pubnames = 1035,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1036,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1037,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1038,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1039,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1040,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1041,                   /* -gsplit-dwarf */
  OPT_gstabs = 1042,                         /* -gstabs */
  OPT_gstabs_ = 1043,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1044,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1045,                        /* -gtoggle */
  OPT_gvms = 1046,                           /* -gvms */
  OPT_gxcoff = 1047,                         /* -gxcoff */
  OPT_gxcoff_ = 1048,                        /* -gxcoff+ */
  OPT_h = 1049,                              /* -h */
  OPT_idirafter = 1050,                      /* -idirafter */
  OPT_imacros = 1051,                        /* -imacros */
  OPT_imultiarch = 1052,                     /* -imultiarch */
  OPT_imultilib = 1053,                      /* -imultilib */
  OPT_include = 1054,                        /* -include */
  OPT_iplugindir_ = 1055,                    /* -iplugindir= */
  OPT_iprefix = 1056,                        /* -iprefix */
  OPT_iquote = 1057,                         /* -iquote */
  OPT_isysroot = 1058,                       /* -isysroot */
  OPT_isystem = 1059,                        /* -isystem */
  OPT_iwithprefix = 1060,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1061,              /* -iwithprefixbefore */
  OPT_k8 = 1062,                             /* -k8 */
  OPT_l = 1063,                              /* -l */
  OPT_lang_asm = 1064,                       /* -lang-asm */
  OPT_mabi_ = 1065,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1066,             /* -mabort-on-noreturn */
  OPT_mapcs = 1067,                          /* -mapcs */
  OPT_mapcs_float = 1068,                    /* -mapcs-float */
  OPT_mapcs_frame = 1069,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1070,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1071,              /* -mapcs-stack-check */
  OPT_march_ = 1072,                         /* -march= */
  OPT_marm = 1073,                           /* -marm */
  OPT_mbig_endian = 1074,                    /* -mbig-endian */
  OPT_mcallee_super_interworking = 1075,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1076,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1077,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1078,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1079,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1080,                  /* -mfp16-format= */
  OPT_mfpu_ = 1081,                          /* -mfpu= */
  /* OPT_mhard_float = 1082, */              /* -mhard-float */
  OPT_mlittle_endian = 1083,                 /* -mlittle-endian */
  OPT_mlong_calls = 1084,                    /* -mlong-calls */
  OPT_mlra = 1085,                           /* -mlra */
  OPT_mneon_for_64bits = 1086,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1087,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1088,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1089,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1090,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1091,            /* -mpoke-function-name */
  OPT_mrestrict_it = 1092,                   /* -mrestrict-it */
  OPT_msched_prolog = 1093,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1094,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1095,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1096, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1097,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1098,                         /* -mthumb */
  OPT_mthumb_interwork = 1099,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1100,                  /* -mtls-dialect= */
  OPT_mtp_ = 1101,                           /* -mtp= */
  OPT_mtpcs_frame = 1102,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1103,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1104,                         /* -mtune= */
  OPT_munaligned_access = 1105,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1106,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1107,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1108,              /* -mword-relocations */
  OPT_mwords_little_endian = 1109,           /* -mwords-little-endian */
  OPT_n = 1110,                              /* -n */
  ...
  OPT_nostartfiles = 1115,                   /* -nostartfiles */
  OPT_nostdinc = 1116,                       /* -nostdinc */
  OPT_nostdinc__ = 1117,                     /* -nostdinc++ */
  OPT_nostdlib = 1118,                       /* -nostdlib */
  OPT_o = 1119,                              /* -o */
  OPT_p = 1120,                              /* -p */
  OPT_pass_exit_codes = 1121,                /* -pass-exit-codes */
  /* OPT_pedantic = 1122, */                 /* -pedantic */
  OPT_pedantic_errors = 1123,                /* -pedantic-errors */
  OPT_pg = 1124,                             /* -pg */
  OPT_pie = 1125,                            /* -pie */
  OPT_pipe = 1126,                           /* -pipe */
  OPT_print_file_name_ = 1127,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1128,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1129,          /* -print-multi-directory */
  OPT_print_multi_lib = 1130,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1131,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1132,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1133,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1134,               /* -print-prog-name= */
  OPT_print_search_dirs = 1135,              /* -print-search-dirs */
  OPT_print_sysroot = 1136,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1137,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1138,                          /* -quiet */
  OPT_r = 1139,                              /* -r */
  OPT_remap = 1140,                          /* -remap */
  OPT_s = 1141,                              /* -s */
  OPT_s_bc_abi = 1142,                       /* -s-bc-abi */
  OPT_save_temps = 1143,                     /* -save-temps */
  OPT_save_temps_ = 1144,                    /* -save-temps= */
  OPT_shared = 1145,                         /* -shared */
  OPT_shared_libgcc = 1146,                  /* -shared-libgcc */
  /* OPT_specs = 1147, */                    /* -specs */
  OPT_specs_ = 1148,                         /* -specs= */
  OPT_static = 1149,                         /* -static */
  OPT_static_libasan = 1150,                 /* -static-libasan */
  OPT_static_libgcc = 1151,                  /* -static-libgcc */
  OPT_static_libgcj = 1152,                  /* -static-libgcj */
  OPT_static_libgfortran = 1153,             /* -static-libgfortran */
  OPT_static_libgo = 1154,                   /* -static-libgo */
  OPT_static_liblsan = 1155,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1156,               /* -static-libstdc++ */
  OPT_static_libtsan = 1157,                 /* -static-libtsan */
  OPT_static_libubsan = 1158,                /* -static-libubsan */
  /* OPT_std_c__03 = 1159, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1160, */                /* -std=c++0x */
  OPT_std_c__11 = 1161,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1162, */                /* -std=c++14 */
  ...
  /* OPT_std_gnu__14 = 1179, */              /* -std=gnu++14 */
